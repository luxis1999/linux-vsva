...
available by checking the IOMMU_NESTING_FEAT_SYSWIDE_PASID flag in the
iommu_nesting_info reported from kernel via VFIO_IOMMU_GET_INFO.
User space could allocate PASID from host by:
