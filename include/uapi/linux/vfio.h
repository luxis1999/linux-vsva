 ...
 *
 * @pasid_quota:	the pasid quota per-application, 0 means
 *			no pasid allocation support.
 ...
 * ALLOC_PASID and FREE_PASID are mutually exclusive. User space should
 * provide min, max no more than the pasid bits reports in iommu nesting
 * info via VFIO_IOMMU_GET_INFO.
 *
