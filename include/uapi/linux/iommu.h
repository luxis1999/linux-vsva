...
/*
 * struct iommu_sva_info_vtd - Intel VT-d specific SVA info.
 *
...
/*
 * struct iommu_sva_info - Information for SVA-capable IOMMU.
 ...
 * @features:	supported SVA features.
 ...
 * | @format                        | data struct                         |
 * +================================+=====================================+
 * | IOMMU_PASID_FORMAT_INTEL_VTD   | struct iommu_sva_info_vtd           |
 * +--------------------------------+-------------------------------------+
 *
 */
struct iommu_sva_info {
	__u32	argsz;
	__u32	flags;
	__u32	format;
#define IOMMU_SVA_FEAT_BIND_PGTBL		(1 << 0)
#define IOMMU_SVA_FEAT_CACHE_INVLD		(1 << 1)
	__u32	features;
	__u16	addr_width;
	__u16	pasid_bits;
	__u8	padding[12];
